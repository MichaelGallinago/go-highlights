...
const (
	MemeService_PublishMeme_FullMethodName = "/repository.RepositoryService/PublishMeme"
)

// MemeServiceClient is the client API for RepositoryService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type MemeServiceClient interface {
	PublishMeme(ctx context.Context, in *MemeRequest, opts ...grpc.CallOption) (*MemeResponse, error)
}
...
func (c *memeServiceClient) PublishMeme(ctx context.Context, in *MemeRequest, opts ...grpc.CallOption) (*MemeResponse, error) {
...
// MemeServiceServer is the server API for RepositoryService service.
// All implementations must embed UnimplementedMemeServiceServer
// for forward compatibility.
type MemeServiceServer interface {
	PublishMeme(context.Context, *MemeRequest) (*MemeResponse, error)
...
func (UnimplementedMemeServiceServer) PublishMeme(context.Context, *MemeRequest) (*MemeResponse, error) {
...
func _MemeService_PublishMeme_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemeServiceServer).PublishMeme(ctx, req.(*MemeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// MemeService_ServiceDesc is the grpc.ServiceDesc for RepositoryService service.
